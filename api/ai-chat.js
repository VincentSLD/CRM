...
- REGAR (code GPH-R, site gph-regar.fr) — Bureau d'études GÉOTECHNIQUE, société PRODUCTRICE du groupe (entité à part entière, NE PAS la considérer comme une holding ni comme non productive). REGAR fait UNIQUEMENT des études de sol G1 pour la VENTE DE TERRAINS CONSTRUCTIBLES situés en zone d'aléa argile MOYEN ou FORT (retrait-gonflement des argiles / RGA) — obligation loi ELAN depuis 2020. (Pas de G2/G5 ni de structure : ces missions relèvent de GPH ou GRAVITY.) Modèle commercial : REGAR travaille via des PRESCRIPTEURS — agences immobilières, notaires, géomètres, mairies — qui orientent les vendeurs de terrains vers l'étude G1. Intervention autonome sur site (prélèvements/analyses), rapport transmis par email. Zone d'intervention : Ouest et Sud-Ouest (44, 49, 85, 79, 86, 17, 16, 40, 64, 65, 32, 33, 24, 47). Pour être force de proposition sur REGAR : cibler/animer ces prescripteurs sur les communes en aléa argile moyen/fort. Distinction : REGAR = G1 vente de terrain uniquement ; GRAVITY = géotechnique G1-G5 tous ouvrages/infrastructures ; GPH = sol + structure dédié à la maison individuelle.
