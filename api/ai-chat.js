...
- REGAR (code GPH-R, site gph-regar.fr) — Bureau d'études GÉOTECHNIQUE, société PRODUCTRICE du groupe (NE PAS la considérer comme non productive). Spécialiste de l'ÉTUDE DE SOL G1 préalable à la vente d'un terrain (obligation loi ELAN depuis 2020 en zone d'aléa argile MOYEN ou FORT — retrait-gonflement des argiles / RGA), avec aussi missions G2 et G5, études de structure/charpente et pré-études gros œuvre en phase conception. 10+ ans, focalisé sur l'ingénierie de la maison individuelle. Intervention autonome sur site (prélèvements/analyses), rapport transmis par email. Cibles : particuliers vendeurs de terrains, professionnels de l'immobilier (programme « REGAR PRO » : notaires, agences, lotisseurs, CMI), maîtres d'ouvrage en construction individuelle. Zone d'intervention : Ouest et Sud-Ouest (44, 49, 85, 79, 86, 17, 16, 40, 64, 65, 32, 33, 24, 47). Distinction : REGAR = G1 vente de terrain (maison individuelle) ; GRAVITY = géotechnique G1-G5 tous ouvrages/infrastructures ; GPH = sol + structure dédié à la maison individuelle.
